...
@section('judul')
    Data Pendaftaran Terbaru | Admin LSP POLITAP
@endsection
...
<div class="page-header">
    <h4>
        <i class="fas fa-users"></i> Data Pendaftaran Terbaru
    </h4>
    <!-- /////////////////////////////////// -->
    <!-- BREADCRUMB -->
    <!-- /////////////////////////////////// -->
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-custom  bg-danger">
            ...
            <li style="color: #fff" class="breadcrumb-item active" aria-current="page">Data Pendaftaran Terbaru</li>
        </ol>
    </nav>
</div><br>
<!-- /////////////////////////////////// -->
    ...
    <div class="card-body">
        <div class="card-description">
            <p><i class="fas fa-info-circle"></i> Informasi :
                <ul>
                    <li>Pada tabel ini menampilkan data pendaftaran sertifikasi terbaru atau
                        data yang belum divalidasi oleh pihak admin.</li>
                    <li>Admin dapat melakukan validasi dengan memproses data pada tabel tersebut tersebut.</li>
                </ul>
            </p>
        </div>
        <div class="row">
